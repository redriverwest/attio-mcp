...
class AttioClient:
    ...
    async def search_people(self, query: str, limit: int = 10) -> dict[str, Any]:
        """
        ...
        logger.info(f"Searching people with query: {query}, limit: {limit}")
        return {"data": [], "total": 0}
    ...
    async def get_person_notes(self, person_id: str) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing person notes
        """
        # Placeholder implementation - will be implemented later
