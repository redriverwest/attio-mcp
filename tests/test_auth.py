...
async def test_bearer_token_verifier_valid_token():
...
async def test_bearer_token_verifier_invalid_token():
...
async def test_bearer_token_verifier_empty_token():
...
async def test_bearer_token_verifier_no_config():
    ...
    result = await verifier.verify_token("any_token")
